...
%%
load ../data/input/Wang/painEEG_clean_1_40Hz;%EEGclean_1_40Hz
% load ../data/input/Wang/PainEEG/processedData_sub2__1_40_hz;
EEGclean_1_40Hz = EEGclean_1_40Hz;
...
for i = start : 2 : -1%57%start+step-1 %57
    prestim = -i;
   ...
   %cfg.trl([1, 2, 4, 5, 6, 8, 9, 10, 12, 13],:) = []; % right cold
    ...
    sdDIFF = sdFIC;
    recon = sdFIC.avg.pow - sdFC.avg.pow;
...
mid1 =2480;
mid2 =5490;
pattern3 = [zeros(mid1-1,1);pattern(mid1:mid2);zeros(8196-mid2,1)];
bnd.pnt = sourcespace.pnt;
bnd.tri = sourcespace.tri;
figure;
...
% left brain: channel 13 = 28.6 71.9 115.6
pnt = sourcespace.pnt;
% pnt=vol.bnd(3).pnt;
x=pnt(:,1);
y=pnt(:,2);
